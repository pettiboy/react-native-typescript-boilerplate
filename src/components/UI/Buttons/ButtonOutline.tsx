...
import { ButtonProps, StyleSheet, Text, TextStyle, TouchableOpacity, TouchableOpacityProps, ViewStyle } from 'react-native';
...
const ButtonOutline: FunctionComponent<ButtonOutlineProps> = (
  ...
  return (
    ...
    {disabled ? (
      ...
      // disabled button
      <TouchableOpacity
        style={[ noDisabledStyle ? styles.button : styles.disabledButton, style ]}
        disabled={disabled}
        onPress={onPress}
      > 
        ...
        {/* disabled text */}
        <Text 
          style={[styles.outlineTextDisabled, textStyle ]}
        >
          {title}
        </Text>
        {iconAlignRight && materialIcon && <MaterialIcons 
      ...
      > 
        ...
        {/* enabled text */}
        <Text 
          style={[ styles.outlineText, textStyle ]}
        >
          {title}
        </Text>
        {iconAlignRight && materialIcon && <MaterialIcons 
